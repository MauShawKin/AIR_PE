...
class ColorStyle:
    def __init__(self, link_color, link_pairs, point_color):
...
# (R,G,B)
A = (252, 176, 243) # pink/left
B = (240, 240, 0) # yellow/right
C = (24, 240, 27) # green/body_line
D = (0, 176, 240) # blue/body_point
...
link_color = [A, B, C, C, A, B, C, A, B, C]
point_color = [D, A, B, A, B, D, D, A, B]

air_style = ColorStyle(link_color, link_pairs, point_color)
...
def parse_args():
    ...
    parser.add_argument('--image-path',
                        ...
                        type=str,
                        default='/home/ly/Dataset/AIR/images/val2017/'
                        )

    parser.add_argument('--gt-anno',
                        help='Path of COCO val annotation',
                        type=str,
                        default='/home/ly/Dataset/AIR/annotations/person_keypoints_val2017.json'
                        )
    ...
    parser.add_argument('--style',
                        help="Style of the visualization: AIR style",
                        type=str,
                        default='AIR')
...
link_pairs, ring_color, save=True):
    ...
    for catId in catIds:
        for imgId in p.imgIds[:5000]:
            ...
            for j, gt in enumerate(gts):
                ...
                for i, dt in enumerate(dts):
                    ...
                    if iou < 0.1 or score < threshold:
                        ...
                        sum_score += dt['score']
                        # reshape
                        dt_joints = np.array(dt['keypoints']).reshape(9, -1)
            ...
            plt.margins(0, 0)
            if save:
                plt.savefig(save_path + img_name + '_score_' + str(np.int(avg_score)) + '.png',
